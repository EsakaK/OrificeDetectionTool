...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(30, 30, 381, 351))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget1)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.o_img = QtWidgets.QLabel(self.layoutWidget1)
        self.o_img.setText("")
        self.o_img.setObjectName("o_img")
        self.verticalLayout.addWidget(self.o_img)
        self.o_label = QtWidgets.QLabel(self.layoutWidget1)
